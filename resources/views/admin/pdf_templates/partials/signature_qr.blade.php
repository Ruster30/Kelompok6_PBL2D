...
--}}
@if(isset($document) && $document && $document->uses_ddms && $document->status === \App\Enums\DocumentStatus::Published && optional($document->qrVerification)->qr_path)
<img src="{{ storage_path('app/public/' . $document->qrVerification->qr_path) }}"
     style="width:96px;height:96px;display:block;margin:0 auto 6px;"
     alt="">
@endif