...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card {
    height: 68px; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px;
    display: flex; align-items: center; padding: 0 8px 0 12px; gap: 10px;
  ...
  .ibox {
    ...
    font-size: 17px; color: #fff; font-weight: 700; line-height: 1;
  }
...
<div class="page">
  ...
  <div class="label-row">
    <span><span class="ch">✓</span> Icon 38px flex + line-height:1</span>
    <span>Gap 10px icon -- teks</span>
    <span>Card padding 0 8px 0 12px</span>
  </div>
</div>
</body>
</html>`;
  ...
  await page.screenshot({ path: 'D:\\Kelompok6_PBL2D\\preview-v2.png', fullPage: true });
  await browser.close();
  console.log('Done');
})();
